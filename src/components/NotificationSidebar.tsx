...
export default function NotificationSidebar({
	...
	return (
		<>
			{/* 오버레이 */}
			<div
				className={`fixed inset-0 bg-gray-900/60 z-40 transition-opacity duration-300 ease-in-out ${
			...
			{/* 사이드바 */}
			<div
				className={`fixed right-0 top-0 w-[440px] h-screen bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
