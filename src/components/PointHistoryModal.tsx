...
export default function PointHistoryModal({
	...
	return (
		<div className="fixed inset-0 bg-gray-900/60 bg-opacity-30 flex items-center justify-center z-50">
			<div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-xl p-4 w-full max-w-lg max-h-[60vh] overflow-hidden">
				{/* 헤더 */}
