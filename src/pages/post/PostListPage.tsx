			...
			<div className="m-auto px-[40px] py-[30px] ">
				...
				<div className="flex py-1 justify-between">
					...
					<div className="inline-flex gap-4">
						<button
							type="button"
							className="h-[33px] px-4 py-2 rounded-xl bg-[#ffffff]
					...
					<button
						type="button"
						className="h-[33px] px-5 py-2 rounded-xl bg-[#8B5CF6]
				...
				<div className="mt-7">
					{/* 글 1 */}
					<div className="w-230 mb-4 px-6 py-4 bg-white rounded-[16px] shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
						{/* 글 제목과 좋아요, 댓글 수 */}
						...
						{/* 작성자 이름 */}
						<p className="mt-[14px] mb-[22px] text-[14px] font-Regular text-[#1F2937]">
							홍길동
						</p>
						{/* 해시태그 */}
						<div className="flex gap-2">
							<div
								className="h-[30px] px-4 py-2 rounded-xl bg-[#EA489A]
